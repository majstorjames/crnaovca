  ...
  return (
    <>
      ...
      <CookieConsent
        ...
        expires={365}
      >
        Koristimo kolačiće ('cookies') kako bi vam pružili bolje korisničko
        iskustvo. Postavke kolačića mogu se kontrolirati i mijenjati u web
        pregledniku. Klikom na gumb 'Prihvati' slažete se s korištenjem
        kolačića.{" "}
      </CookieConsent>
    </>
  );
